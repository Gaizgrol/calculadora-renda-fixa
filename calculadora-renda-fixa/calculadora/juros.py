...
class Juros(ABC):
    ...
    @abstractmethod
    def dividir_unidade_tempo(self, *, razao: int, nova_unidade_tempo: str) -> Self:
        return NotImplemented

    @abstractmethod
    def multiplicar_unidade_tempo(self, *, fator: int, nova_unidade_tempo: str) -> Self:
        return NotImplemented
    ...
    def __str__(self) -> str:
        return f'{self.__class__.__name__}({self.taxa(base_100=True).quantize(Decimal('1.0000'))}% {self._unidade_tempo})'
...
class JurosSimples(Juros):
    def __init__(self, *, taxa: Decimal | str, unidade_tempo='DU'):
        super().__init__(taxa=taxa, unidade_tempo=unidade_tempo)

    @override
    def dividir_unidade_tempo(self, *, razao: int, nova_unidade_tempo: str):
        return JurosSimples(
    ...
    @override
    def multiplicar_unidade_tempo(self, *, fator: int, nova_unidade_tempo: str):
        return JurosSimples(
